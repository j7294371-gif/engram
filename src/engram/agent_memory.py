"""AgentMemory — the primary interface to the engram memory system.
...
from engram.embedding import NoopEmbeddingProvider
...
class AgentMemory:
    """Primary interface to the engram memory system.
    ...
    def recall(
        ...
        **metadata_filters: Any,
        ...
        """
        from engram.memory.enums import MemoryType as MT
...
def _ensure_backends_registered() -> None:
    ...
    _try_register("sqlite", "engram.storage.sqlite", "SQLiteBackend")
    _try_register("chromadb", "engram.storage.chromadb", "ChromaDBBackend")
    _try_register("qdrant", "engram.storage.qdrant", "QdrantBackend")
    _try_register("pgvector", "engram.storage.pgvector", "PGVectorBackend")
